...
<div class="wp-block-group alignfull has-neutral-100-background-color has-background" style="padding-top:var(--wp--preset--spacing--xxl);padding-bottom:var(--wp--preset--spacing--xxl)">
	...
	<h2 class="wp-block-heading has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--xl)">Why Choose Us</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<h3 class="wp-block-heading has-text-align-center">Lightning Fast</h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">Optimized for speed with minimal CSS and JavaScript. Your visitors will love the fast loading times.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">Clean, modern aesthetics that put your content first. Fully customizable to match your brand.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">Built on WordPress best practices with security and reliability at the core.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
